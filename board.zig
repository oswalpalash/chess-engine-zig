...
pub const Position = struct {
    ...
    pub fn init() Position {
        ...
        whitepieces.Rook[0].position = 0x1;
        whitepieces.Rook[1].position = 0x80;
        whitepieces.Bishop[0].position = 0x4;
        whitepieces.Bishop[1].position = 0x20;
        whitepieces.Knight[0].position = 0x2;
        whitepieces.Knight[1].position = 0x40;
        whitepieces.Pawn[0].position = 0x100;
        whitepieces.Pawn[1].position = 0x200;
        whitepieces.Pawn[2].position = 0x400;
        whitepieces.Pawn[3].position = 0x800;
        whitepieces.Pawn[4].position = 0x1000;
        whitepieces.Pawn[5].position = 0x2000;
        whitepieces.Pawn[6].position = 0x4000;
        whitepieces.Pawn[7].position = 0x8000;
